	...
	$form = '
		<form name="' . $args['form_id'] . '" id="' . $args['form_id'] . '" action="' . esc_url( site_url( 'wp-login.php', 'login_post' ) ) . '" method="post">
			...
			<p class="login-username">
				...
				<input type="text" name="log" id="' . esc_attr( $args['id_username'] ) . '" class="input" value="' . esc_attr( $args['value_username'] ) . '" size="20" onkeyup="check_emailact(this.value);" onpaste="check_emailact(this.value);" onfocus="check_emailact(this.value);" autocomplete="off"/>
                         <div class="error-span"><span id="error_emailact"></span></div>                
			</p>
			...
			<p class="login-submit">
				<input type="submit" name="wp-submit" id="' . esc_attr( $args['id_submit'] ) . '" class="button button-big button-line-dark submit button button-primary" value="' . esc_attr( $args['label_log_in'] ) . '" />
                                <a href="http://krec1991.com/resetpwd/?action=lostpassword" class="button button-big button-line-dark submit button button-primary" />Reset Password</a>
